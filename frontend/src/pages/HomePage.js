...
function QualificaitonProfile() {
  return (
    <div>
      <ul>
        <h3 style={{ background: "yellow" }}>QUALIFICATIONS PROFILE</h3>
        <li>
...
function Education() {
  return (
    <div>
      <ul>
        <h3 style={{ background: "yellow" }}>EDUCATION</h3>
        <li>
...
function WorkExperience() {
  return (
    <ul>
      <h3 style={{ background: "yellow" }}>WORK EXPERIENCE</h3>
      <li>
        <strong>
          beBitTECH
        ...
        <ul>
          ...
          <li>
            Introduced KEDA autoscaler to optimize Kubernetes pod scaling based
            on RabbitMQ queue length, rather than CPU usage.
          </li>
          <li>
            Developed a comprehensive deployment SOP for our new environment and
            conducted rigorous load testing to simulate the impact of concurrent
            user loads on database and API performance.
          </li>
          <li>
          ...
          <li>
            Led a team of backend developers in the design and implementation of
          ...
          <li>
            ...
            recommendations for optimization and enhancement, driving continuous
            improvement efforts.
          </li>
          <li>
